...
import it.uniroma2.sag.kelp.learningalgorithm.regression.liblinear.LibLinearRegression;
...
public class LibsvmFormatReaderRegressionTest {
	...
	public static void loadDatasetAndPrepareKernel() {
		...
		try {
			LibsvmDatasetReader trainReader = new LibsvmDatasetReader("src/test/resources/svmTest/libsvmFormat/regression/housing_train", REPRESENTATION_NAME, property);
			LibsvmDatasetReader testReader = new LibsvmDatasetReader("src/test/resources/svmTest/libsvmFormat/regression/housing_test", REPRESENTATION_NAME, property);
	...
	public void testAccuracy() {
		...
		LibLinearRegression libLinear = new LibLinearRegression(property, 1, 0.1f, REPRESENTATION_NAME);
		libLinear.learn(trainset);
		UnivariateRegressionFunction regressor = (UnivariateRegressionFunction) libLinear.getPredictionFunction();
